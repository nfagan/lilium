...
var Module = typeof FastGrass !== 'undefined' ? FastGrass : {};
...
var wasmBinaryFile = 'fast-grass.wasm';
...
var _fast_grass_update = Module["_fast_grass_update"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_fast_grass_update"].apply(null, arguments)
};
...
if (typeof exports === 'object' && typeof module === 'object')
      ...
      define([], function() { return FastGrass; });
    else if (typeof exports === 'object')
      exports["FastGrass"] = FastGrass;
